...
Along with providing basic chat functionality, it also manrains a log file that reconds all conversation details in a periodic fashion for fature reference
